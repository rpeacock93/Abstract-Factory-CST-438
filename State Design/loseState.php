<?php 
	...
	class loseState implements GameState {

		public function loseState($newGameMachine) {
		...
		public function displayStats() {
			// Display updated score from Loss
			// Display how many moves user completed
